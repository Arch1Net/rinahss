...
const songs: Song[] = [
  {
    ...
    artist: "Taylor Swift",
    duration: "5:52",
    src: import.meta.env.BASE_URL + "music/Enchanted.mp3",
  },
  {
    id: 2,
    title: "Daylight",
    artist: "Taylor Swift",
    duration: "4:49",
    src: import.meta.env.BASE_URL + "music/Daylight.mp3",
  },
  {
    id: 3,
    ...
    artist: "Taylor Swift",
    duration: "3:54",
    src: import.meta.env.BASE_URL + "music/Wildest Dreams.mp3",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    artist: "The 1975",
    duration: "5:25",
    src: import.meta.env.BASE_URL + "music/About You.mp3",
  },
];
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-lg text-gray-600 mb-10 text-center">
            A collection of songs for rinahs.
          </p>
            ...
            <div className="p-6 bg-gradient-to-r from-pink-100 to-pink-50">
              <div className="flex flex-col md:flex-row items-center">
                <div className="w-40 h-40 rounded-full overflow-hidden shadow-lg mb-6 md:mb-0 md:mr-8 flex-shrink-0">
                  <img
                    src={
                      import.meta.env.BASE_URL + "images/flowers/peonies.jpg"
                    }
                    alt="Album Art"
                  ...
                  >
                    <div className="flex items-center">
                      {currentSong.id === song.id && isPlaying ? (
                        ...
                        <span className="w-4 h-4 flex items-center justify-center mr-3 text-xs text-gray-500">
                          {song.id}
                        </span>
                      )}
